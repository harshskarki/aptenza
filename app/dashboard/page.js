...
export default function DashboardPage() {
  ...
  async function handleResumeUpload(e) {
    ...
    if (uploadError) { setUploadMessage('Upload failed. Please try again.'); setUploading(false); return }
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <motion.div variants={stagger} initial="hidden" animate="visible" className="mb-10">
          ...
          <motion.p variants={fadeUp} className="text-gray-500 dark:text-gray-400 mt-2">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible"
          className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-white/5 mb-10 transition-colors"
        >
          ...
          {profile?.resume_url ? (
            ...
            <motion.div
              ...
              className="border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-indigo-500 rounded-xl px-6 py-10 text-center cursor-pointer transition-colors"
            >
          ...
          {uploadMessage && !uploading && (
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}
              className={`text-sm mt-3 ${uploadMessage.includes('success') ? 'text-green-500' : uploadMessage.includes('removed') ? 'text-gray-400' : 'text-red-500'}`}
            >
              {uploadMessage}
            </motion.p>
          )}
        ...
        {/* Interview types */}
        <motion.h3 variants={fadeUp} initial="hidden" animate="visible" className="text-lg font-bold mb-4">
