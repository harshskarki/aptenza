...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white overflow-x-hidden transition-colors duration-300">
      ...
      <motion.nav
        ...
        className="fixed top-0.5 left-0 right-0 z-50 border-b border-gray-200 dark:border-white/5 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md transition-colors duration-300"
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => router.push('/pricing')} className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition">Pricing</button>
            <ThemeToggle />
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16 relative">
        ...
        <motion.div style={{ y: heroY }} className="relative z-10 text-center max-w-4xl mx-auto">
          <motion.div
            ...
            className="inline-flex items-center gap-2 border border-indigo-500/30 bg-indigo-500/10 text-indigo-600 dark:text-indigo-300 text-xs px-4 py-2 rounded-full mb-8 font-medium"
          >
          ...
          <motion.p
            ...
            className="text-gray-500 dark:text-gray-400 text-xl max-w-2xl mx-auto mb-10 leading-relaxed"
          >
          ...
          >
            ...
            <motion.button
              ...
              className="w-full sm:w-auto text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white px-8 py-4 rounded-xl text-base transition border border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-white/20"
            >
              View pricing →
            </motion.button>
          </motion.div>
        ...
        >
          <div className="bg-gray-50 dark:bg-gray-900/80 border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-sm">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-200 dark:border-white/5">
              ...
              <span className="ml-2 text-xs text-gray-400">DSA Interview · In progress</span>
            </div>
            <div className="p-6 space-y-4">
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.2, duration: 0.5 }} className="flex gap-3 justify-end">
              ...
              <div className="flex items-center gap-2 pt-2">
                <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-xl px-4 py-2.5 text-sm text-gray-400">Type your answer...</div>
                <div className="bg-indigo-600 rounded-xl px-4 py-2.5 text-sm font-semibold text-white">Send</div>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <motion.section
        ...
        className="border-y border-gray-200 dark:border-white/5 py-12"
      >
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-3 gap-6 text-center">
          <motion.div variants={fadeUp}>
            <p className="text-4xl font-black"><AnimatedCounter target={1240} />+</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        >
          ...
          <p className="text-gray-500 text-lg">Not a question bank. A real interviewer.</p>
        </motion.div>
        ...
        >
          ...
          {[
            ...
            <motion.div
              ...
              variants={fadeUp}
              whileHover={{ scale: 1.02 }}
              className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 border border-gray-200 dark:border-white/5 transition-colors cursor-default"
            >
      ...
      {/* Testimonials */}
      <section className="border-t border-gray-200 dark:border-white/5 py-24 bg-gray-50 dark:bg-gray-900/30 transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            {[
              ...
              { initial: 'P', name: 'Priya S.', role: 'CS Final Year · Pune', color: 'bg-purple-700', border: 'border-indigo-200 dark:border-indigo-500/30', text: '"Better than paying ₹5000 for mock interviews. The AI asks follow-up questions just like a real interviewer. Highly recommend for freshers."' },
              { initial: 'A', name: 'Arjun K.', role: 'MBA · Mumbai', color: 'bg-green-700', border: 'border-gray-200 dark:border-white/5', text: '"The behavioral interview practice helped me structure my answers using STAR. Cleared 3 HR rounds back to back after practicing here."' },
            ].map((t, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                whileHover={{ scale: 1.03, y: -4 }}
                className={`bg-white dark:bg-gray-900 rounded-2xl p-6 border ${t.border} transition-colors`}
              >
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 ${t.color} rounded-full flex items-center justify-center text-xs font-bold text-white`}>{t.initial}</div>
                  <div>
      ...
      <footer className="border-t border-gray-200 dark:border-white/5 px-6 py-8 transition-colors duration-300">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => router.push('/pricing')} className="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">Pricing</button>
            <button onClick={() => router.push('/login')} className="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">Sign in</button>
            <button onClick={() => router.push('/signup')} className="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">Sign up</button>
          </div>
